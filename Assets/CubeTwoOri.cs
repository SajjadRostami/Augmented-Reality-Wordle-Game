...
namespace Microsoft.MixedReality.Toolkit.Examples.Demos
{
    ...
    public class CubeTwoOri : MonoBehaviour, IMixedRealityTouchHandler
    {
        [SerializeField]
        ...
        void IMixedRealityTouchHandler.OnTouchStarted(HandTrackingInputEventData eventData)
        {
            ...
            foreach (GameObject go in GameObject.FindGameObjectsWithTag("FakeCubeTwo"))
            {
            ...
            foreach (GameObject go in GameObject.FindGameObjectsWithTag("CubeThreeOri"))
            {
                Renderer renderer = go.GetComponent<Renderer>();
                if (renderer != null)
                {
            ...
            foreach (GameObject go in GameObject.FindGameObjectsWithTag("Board"))
            {
                ...
                if (renderer != null)
                {
                    renderer.text = "Step 3: Touch the next green rectangle.";
                }
            }
        }
