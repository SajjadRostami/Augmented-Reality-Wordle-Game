...
namespace Microsoft.MixedReality.Toolkit.Examples.Demos
{
    ...
    public class CubeFiveOri : MonoBehaviour, IMixedRealityTouchHandler
    {
        [SerializeField]
        ...
        void IMixedRealityTouchHandler.OnTouchStarted(HandTrackingInputEventData eventData)
        {
            ...
            foreach (GameObject go in GameObject.FindGameObjectsWithTag("FakeBaseCube"))
            {
            ...
            foreach (GameObject go in GameObject.FindGameObjectsWithTag("Board"))
            {
                ...
                if (renderer != null)
                {
                    renderer.text = "Well done, you finished the game.";
                }
            }
        }
