...
namespace Microsoft.MixedReality.Toolkit.Examples.Demos
{
    ...
    public class CubeOneOri : MonoBehaviour, IMixedRealityTouchHandler
    {
        [SerializeField]
        ...
        private void Start()
        {
            ...
            positionX = TargetRenderer.transform.position.z;
        ...
        void IMixedRealityTouchHandler.OnTouchStarted(HandTrackingInputEventData eventData)
        {
            ...
            foreach (GameObject go in GameObject.FindGameObjectsWithTag("FakeCubeOne"))
            {
            ...
            foreach (GameObject go in GameObject.FindGameObjectsWithTag("CubeTwoOri"))
            {
                Renderer renderer = go.GetComponent<Renderer>();
                if (renderer != null)
                {
            ...
            foreach (GameObject go in GameObject.FindGameObjectsWithTag("Board"))
            {
                ...
                if (renderer != null)
                {
                    renderer.text = "Step 2: Touch the next green rectangle.";
                }
            }
