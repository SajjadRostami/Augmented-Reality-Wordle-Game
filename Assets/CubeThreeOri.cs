...
namespace Microsoft.MixedReality.Toolkit.Examples.Demos
{
    ...
    public class CubeThreeOri : MonoBehaviour, IMixedRealityTouchHandler
    {
        [SerializeField]
        ...
        void IMixedRealityTouchHandler.OnTouchStarted(HandTrackingInputEventData eventData)
        {
            ...
            foreach (GameObject go in GameObject.FindGameObjectsWithTag("FakeCubeThree"))
            {
            ...
            foreach (GameObject go in GameObject.FindGameObjectsWithTag("CubeFourOri"))
            {
                Renderer renderer = go.GetComponent<Renderer>();
                if (renderer != null)
                {
            ...
            foreach (GameObject go in GameObject.FindGameObjectsWithTag("Board"))
            {
                ...
                if (renderer != null)
                {
                    renderer.text = "Step 4: Touch the next green rectangle.";
                }
            }
        }
